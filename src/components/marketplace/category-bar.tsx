        ...
        <button
          ...
          className={cn(
            ...
            selectedCategory === null
              ...
              : "bg-white text-slate-700 hover:bg-slate-50 border border-slate-200/80 dark:bg-slate-900 dark:text-slate-300 dark:border-slate-800 dark:hover:bg-slate-800"
          )}
        >
