                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div className="sm:col-span-2 space-y-1.5">
                        ...
                        <textarea
                          ...
                          placeholder="Origine des ingrédients au Gabon, bienfaits, conseils d'utilisation..."
                          className="w-full rounded-xl border border-slate-200 bg-white p-3 text-xs text-slate-900 placeholder:text-slate-400 focus:border-emerald-500 focus:outline-none dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
                        />
                      </div>
                    </div>
